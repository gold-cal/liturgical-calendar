...
class TaskActivity : SimpleActivity() {
    ...
    private fun isTaskChanged(): Boolean {
        ...
        return task_title.text.toString() != mTask.title ||
    ...
    private fun gotTask(savedInstanceState: Bundle?, localEventType: EventType?, task: Event?) {
        ...
        task_type_holder.setOnClickListener { showTaskTypeDialog() }
    ...
    private fun updateTaskType() {
        ensureBackgroundThread {
            ...
            if (taskType != null) {
                runOnUiThread {
                    task_type.text = taskType.title
                    task_type_color.setFillWithStroke(taskType.color, getProperBackgroundColor())
                }
            }
        }
    }
